...
function App() {
  ...
  ${sidebarOpen ? "translate-x-0" : "-translate-x-42"}
`}
        >
          <button
            id="mode"
        ...
        <button
          ...
          className={`px-2 text-right w-[40px] text-[12px] md:hidden fixed top-[12px] z-30 ${
            sidebarOpen ? "left-38" : "-translate-x-5"
          }`}
        >
          ☰
        </button>
        ...
        <div id="rightside" className="p-0 ">
          <div className="z-20 absolute mt-[15px] !mx-0 md:p-0 place-items-center md:w-full ">
            ...
            <p className="mx-5">
              - A passionate ITE student always ready to work, create, and
              comunicate.
            </p>
            <p className="my-28">
            ...
            <div className="w-full place-items-center">
              <div id="contact">
                ...
                <form id=":P" action="https://formspree.io/f/xyzppzrd" method="POST">
                  <label htmlFor="message">
                    Something wrong? Send a message:
                  </label>
                  <textarea
                    id="message"
                    name="message"
          ...
          <div id="image" className="z-0 p-0 w-[98vw] md:w-[85vw]  h-full ">
            {isDarkMode ? (<>
              <div className="brightness-300 opacity-15 md:brightness-110 md:opacity-100 h-[800px] md:h-[900px]">
                ...
                <img src={cdark} className="img mt-20 rotate-180 float-right " />
              </div>
              <div className="brightness-300 opacity-15 md:brightness-110 md:opacity-100 h-[800px] md:h-[900px]">
                <img src={cdark} className="img " />
                <img src={cdark} className="img mt-20 rotate-180 float-right" />
              ...
              <div className="opacity-80 md:opacity-80 h-[800px] md:h-[900px]">
                ...
                <img src={clight} className="img mt-20 rotate-180 float-right "/>
              </div>
              <div className="opacity-80 md:opacity-80 h-[800px] md:h-[900px]">
                <img src={clight} className="img " />
                <img src={clight} className="img mt-20 rotate-180 float-right "/>
